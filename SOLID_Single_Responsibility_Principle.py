...
class Journal:
    ...
    # Â¡WARNING! : estos mÃ©todos sobran en la clase caen en otra responsabilidad de la clase
...
#Mejor prÃ¡ctica : El proceso de guardado debe ir en una clase con una Ãºnica responsabilidad.
